...
from gen.constants.hgen_constants import INPUTS_FOR_GENERATION_PATH
from gen.hgen.common.hgen_util import HGenUtil
from gen.hgen.hgen_args import HGenArgs, PredictionStep
from gen.hgen.hgen_prompts import FORMAT_QUESTIONNAIRE, INSTRUCTION_CREATION_PROMPT
...
class GenerateInputsStep(AbstractPipelineStep[HGenArgs, HGenState]):
    ...
    def _get_inputs(hgen_args: HGenArgs) -> Tuple[List, str, str, str]:
        ...
        """
        instructions_prompt: Prompt = INSTRUCTION_CREATION_PROMPT
        instructions_prompt.response_manager.value_formatter = lambda tag, val: HGenUtil.parse_generated_artifacts(val)
        format_questionnaire: QuestionnairePrompt = FORMAT_QUESTIONNAIRE
