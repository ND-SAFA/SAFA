from tgen.common.constants.open_ai_constants import TOKENS_2_CHARS_CONVERSION
...
class TestNaturalLanguageChunker(BaseTest):
    ...
    def test_chunk(self):
        ...
        long_text = "Hello " * (n_times_limit * round(chunker.max_prompt_tokens * TOKENS_2_CHARS_CONVERSION))
