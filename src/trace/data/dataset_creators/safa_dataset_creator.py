...
class SafaDatasetCreator(AbstractDatasetCreator):
    ...
    TRACE_FILE_2_ARTIFACT = {SafaKey.FR2SG_FILE: (SafaKey.FUNCTIONAL_REQUIREMENTS_FILE, SafaKey.SAFETY_GOALS_FILE),
                             SafaKey.SR2FR_FILE: (SafaKey.SYSTEM_REQUIREMENTS_FILE, SafaKey.FUNCTIONAL_REQUIREMENTS_FILE),
                             SafaKey.SWR2SR_FILE: (SafaKey.SOFTWARE_REQUIREMENTS_FILE, SafaKey.SYSTEM_REQUIREMENTS_FILE),
                             SafaKey.HWR2SR_FILE: (SafaKey.HARDWARE_REQUIREMENTS_FILE, SafaKey.SYSTEM_REQUIREMENTS_FILE)}
    ...
    def __init__(self, project_path: str, model_generator: ModelGenerator,
        ...
        """
        Creates a dataset from the SAFA data format.
        ...
        self.dataset = Dataset(links=links, arch_type=model_generator.arch_type, pos_link_ids=pos_link_ids,
    ...
    def _create_artifacts(project_path: str, feature_func: Callable) -> Dict[str, List[Artifact]]:
        ...
        for artifact_file in SafaDatasetCreator.ARTIFACT_FILES:
            artifact_layers[artifact_file] = SafaDatasetCreator._create_artifacts_from_file(project_path, artifact_file, feature_func)
    ...
    def _create_links(artifact_layers: Dict[str, List[Artifact]], pos_link_ids: Set[int], feature_func: Callable) \
        ...
        for trace_file, artifact_files in SafaDatasetCreator.TRACE_FILE_2_ARTIFACT:
            ...
            layer_links = SafaDatasetCreator._create_links_for_layer(source_artifacts, target_artifacts, pos_link_ids, feature_func)
    ...
    def _create_artifacts_from_file(project_path: str, data_file_name: str, feature_func: Callable) -> List[Artifact]:
        ...
        for artifact_entry in data_file[SafaKey.ARTIFACTS]:
            artifacts.append(Artifact(artifact_entry[SafaKey.ARTIFACT_ID], artifact_entry[SafaKey.ARTIFACT_TOKEN], feature_func))
        return artifacts
