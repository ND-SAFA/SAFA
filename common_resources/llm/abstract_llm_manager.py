...
from common_resources.tools.constants.model_constants import TRAIN_TASK, PREDICT_TASK
from common_resources.llm.args.abstract_llm_args import AbstractLLMArgs
from common_resources.llm.llm_responses import SupportedLLMResponses
...
class AbstractLLMManager(BaseObject, ABC, Generic[AIObject]):
    ...
    def make_fine_tune_request(self, completion_type: LLMCompletionType, instructions: Dict, **kwargs) -> AIObject:
        ...
        """
        params = self.llm_args.to_params(TRAIN_TASK, completion_type, instructions=instructions, **kwargs)
    ...
    def _get_enum_class(cls, child_class_name: str) -> Type:
        ...
        """
        from common_resources.llm.supported_llm_manager import SupportedLLMManager
