...
from common_resources.graph.io.graph_state import GraphState, has_state_value
from common_resources.graph.io.graph_state_vars import GraphStateVars
from common_resources.graph.llm_tools.tool import ToolType
from common_resources.llm.prompts.context_prompt import ContextPrompt
from common_resources.llm.prompts.input_prompt import InputPrompt
...
from common_resources.llm.prompts.prompt_args import PromptArgs
...
from common_resources.tools.constants.environment_constants import ANTHROPIC_KEY, OPEN_AI_KEY
from common_resources.tools.constants.graph_defaults import BASE_AGENT_DEFAULT_MODEL
...
class BaseAgent:
    ...
    def _get_system_prompt(self, state: Dict = None) -> Prompt:
        ...
        if isinstance(system_prompt, str):
            return Prompt(system_prompt, prompt_args=PromptArgs(system_prompt=True))
