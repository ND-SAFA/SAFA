...
exports.updatePassword = exports.createPasswordReset = exports.createLoginSession = exports.createUser = void 0;
...
function sessionFetch() {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch(api_1.baseURL + "/" + args[0], args[1])];
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
...
function createUser(user) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, sessionFetch(api_1.fillEndpoint(api_1.Endpoint.createAccount), {
                    method: "POST",
...
function createLoginSession(user) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, sessionFetch(api_1.fillEndpoint(api_1.Endpoint.login), {
                    method: "POST",
                    body: JSON.stringify(user)
                })];
        });
...
function createPasswordReset(user) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, api_1.authHttpClient(api_1.fillEndpoint(api_1.Endpoint.forgotPassword), {
                        method: "PUT",
                        body: JSON.stringify(user)
                    })];
                case 1:
...
function updatePassword(user) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, api_1.authHttpClient(api_1.fillEndpoint(api_1.Endpoint.resetPassword), {
                        method: "PUT",
                        body: JSON.stringify(user)
                    })];
                case 1:
