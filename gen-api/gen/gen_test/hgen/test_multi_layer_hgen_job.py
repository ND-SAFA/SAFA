...
from gen_common.clustering.base.cluster_dataset_creator import ClusterDatasetCreator
...
from gen_common_test.base.mock.decorators.libraries import mock_libraries
...
from gen_test.hgen.hgen_test_utils import HGenTestConstants, get_all_responses, get_predictions
        ...
        args = HGenArgs(source_layer_ids="C++ Code",
                        ...
                        dataset_creator=PromptDatasetCreator(
                            ...
                            trace_dataset_creator=TraceDatasetCreator(
                                DataFrameProjectReader(project_path=GEN_TEST_PROJECT_HGEN_PATH))),
