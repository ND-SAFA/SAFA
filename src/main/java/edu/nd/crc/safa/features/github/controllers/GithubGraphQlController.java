...
public class GithubGraphQlController extends BaseController {
     ...
     */
    @GetMapping(AppRoutes.Github.RETRIEVE_GITHUB_REPOSITORIES + "/graphql")
    ...
    private <T, R extends GithubResponse<?>> DeferredResult<T> makeDeferredRequest(String queryLocation,
        ...
        executorDelegate.submit(output, () -> {
            ...
            R response = makeGraphQlRequest(user, queryLocation, responseClass);
    ...
    /**
     * Perform a deferred GraphQL request which will make the request with the given query schema
     * and return the result. This is the same as {@link #makeDeferredRequest(String, Class, Function)}
    ...
    private <T extends GithubResponse<?>> DeferredResult<T> makeDeferredRequest(String queryLocation,
        ...
        return makeDeferredRequest(queryLocation, responseClass, Function.identity());
    }
    ...
    private <T extends GithubResponse<?>> T makeGraphQlRequest(SafaUser user, String queryLocation,
                                                               Class<T> reponseClass) throws IOException {
