...
from gen_test.hgen.hgen_test_utils import HGenTestConstants, get_generated_artifacts_response, get_name_responses, get_test_hgen_args
...
class TestHierarchyGenerator(BaseTest):
    ...
    def assert_generate_trace_links_step(self, sim_mock: MagicMock, anthropic_ai_manager: TestAIManager, ):
        ...
        responses.extend([RankingPipelineTest.get_response(task_prompt=EXPLANATION_TASK_QUESTIONNAIRE)
