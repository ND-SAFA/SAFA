...
exports.timGraph = {
    ...
    plugins: [
        ...
        },
        {
            ...
            afterInit: function (cy) { return cy.nodeHtmlLabel([styles_1.timNodeHtml]); }
        },
    ],
    afterInit: function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, store_1.viewportModule.setTimTreeLayout()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
