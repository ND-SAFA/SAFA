...
if __name__ == "__main__":
    project_path = os.path.join(os.getenv("DATA_PATH"), "dr_onboard_autonomy") if DO_SUMMARIZE else \
        os.path.join(os.getenv("DATA_PATH"), "dr_onboard_autonomy_summarizations")
