...
from gen.delta.delta_prompts import CHANGE_SUMMARY_QUESTIONNAIRE, CHANGE_SUMMARY_STARTER_PROMPT, DIFF_SUMMARY_QUESTIONNAIRE
...
class OverviewChangeSummaryStep(AbstractPipelineStep[DeltaArgs, DeltaState]):
    ...
    IMPACT_TAG_ID: QuestionnairePrompt = DIFF_SUMMARY_QUESTIONNAIRE.get_response_tags_for_prompt(-1)
    ...
    def _run(self, args: DeltaArgs, state: DeltaState) -> None:
        ...
        task_prompt: QuestionnairePrompt = CHANGE_SUMMARY_QUESTIONNAIRE
    ...
    def _get_output(args: DeltaArgs, state: DeltaState, artifact_df: ArtifactDataFrame, task_prompt: QuestionnairePrompt) -> Dict:
        ...
        prompts = [CHANGE_SUMMARY_STARTER_PROMPT,
                   MultiArtifactPrompt(
