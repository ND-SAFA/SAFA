...
public class TestDeltaController extends EntityBaseTest {
    ...
    public void testModificationDetected() throws Exception {
        ...
        ProjectAppEntity projectAppEntity = this.projectService.createApplicationEntity(afterVersion);
        assertThat(projectAppEntity.getArtifacts().size()).isEqualTo(TestConstants.N_ARTIFACTS);
    }
}
