...
import edu.nd.crc.safa.test.features.documents.base.AbstractDocumentTest;
 ...
 */
class TestCreateFmeaDocument extends AbstractDocumentTest {
    ...
    private void assertDocumentColumnJson(JSONObject documentColumnJson, String name,
                                          DocumentColumnDataType columnType) {
