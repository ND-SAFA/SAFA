...
class AbstractJob:
    ...
    def __init__(self, model_path: str, base_model: SupportedBaseModel, output_dir: str, add_mount_directory_to_output: bool = True,
                 save_output: bool = SAVE_OUTPUT_DEFAULT):
        """
        The base job class
