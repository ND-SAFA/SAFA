...
from gen.hgen.common.special_doc_types import DocTypeConstraints
from gen.hgen.hgen_args import HGenArgs
from gen.hgen.hgen_prompts import GENERATATION_QUESTIONNAIRE, GENERATION_PROMPT, SEED_PROMPT
from gen.hgen.hgen_state import HGenState
from gen.hgen.supported_hgen_doc_type_prompts import SupportedHGenDocPrompts
...
class GenerateArtifactContentStep(AbstractPipelineStep[HGenArgs, HGenState]):
    ...
    def _run(self, args: HGenArgs, state: HGenState) -> None:
        ...
        base_task_prompt = GENERATATION_QUESTIONNAIRE if not state.cluster2artifacts \
            else SupportedHGenDocPrompts.get_prompt_by_type(args.target_type).value
    ...
    def _add_seeds_to_prompt(dataset: PromptDataset, prompt_builder: PromptBuilder, state: HGenState) -> None:
        ...
        prompt_builder.add_prompt(SEED_PROMPT, -2)
