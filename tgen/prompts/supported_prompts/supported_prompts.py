...
from tgen.prompts.supported_prompts.hgen_prompts import FORMAT_QUESTIONNAIRE, GENERATION_PROMPT, INSTRUCTION_CREATION_PROMPT, \
    REFINE_PROMPT, REFINE_TASKS, SUMMARY_QUESTIONNAIRE, GENERATATION_QUESTIONNAIRE, CLUSTERING_QUESTIONNAIRE
from tgen.prompts.supported_prompts.project_summary_prompts import PROJECT_SUMMARY_CONTEXT_PROMPT, OVERVIEW_SECTION_PROMPT, \
...
class SupportedPrompts(SupportedEnum):
    ...
    PROJECT_SUMMARY_CONTEXT = PROJECT_SUMMARY_CONTEXT_PROMPT
