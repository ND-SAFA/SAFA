...
from gen_common.clustering.clustering_pipeline import ClusteringPipeline
from gen_common.constants.symbol_constants import DASH
...
from gen_common.pipeline.util import nested_pipeline
...
from gen.constants.hgen_constants import DEFAULT_DUPLICATE_CLUSTER_MIN_SIM_THRESHOLD, \
    DEFAULT_DUPLICATE_SIMILARITY_THRESHOLD
from gen.hgen.common.hgen_types import ArtifactPair, CountMap, MatrixIndex
...
class DuplicateDetector:
    ...
    def cluster_duplicates(self, artifact_df: ArtifactDataFrame, duplicate_type: DuplicateType = DuplicateType.ALL,
        ...
        # TODO: How do centroids even get allowed into the embedding manager.
