...
from testres.paths.project_paths import STRUCTURE_PROJECT_PATH, CSV_PROJECT_PATH
...
class TestMultiTraceDatasetCreator(BaseTraceTest):
    ...
    def test_create(self):
        dataset_creator = self.get_multi_trace_dataset_creator()
        multi_dataset = dataset_creator.create()
    ...
    def get_multi_trace_dataset_creator(self):
