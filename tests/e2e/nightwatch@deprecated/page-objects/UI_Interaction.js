...
module.exports = {
  ...
  elements: {
    ...
    TestDataLocation: "tests/e2e/test-data/",
    ...
    traceLinkNoInputWarning:
      'div[class="ma-1 pa-0 text-center white--text col col-9 align-self-center"]',
    ...
    checkMarkIcon:
      'i[aria-hidden="true"][class="v-icon notranslate mdi mdi-check theme--light success--text"]:last-child',
    errorMarkIcon:
      'i[aria-hidden="true"][class="v-icon notranslate mdi mdi-close theme--light error--text"]:last-child',
    dropDownIcon:
      'i[aria-hidden="true"][class="v-icon notranslate mdi mdi-chevron-down theme--light"]',
    deleteProjectIcon:
      'i[aria-hidden="true"][class="v-icon notranslate mdi mdi-delete theme--light"]',
    closeWindowIcon:
      'i[aria-hidden="true"][class="v-icon notranslate mdi mdi-close theme--light"]',

    /* Tim Graph Elements */
    timGraph: 'canvas[data-id="layer1-drag"]',
    zoomInButton: 'button[id="zoom-in"]',
    centerGraphButton:
      '(//*[@aria-expanded="false" and @type="button" and @class="v-btn v-btn--icon v-btn--round theme--light v-size--default secondary--text"])[5]',
  ...
  commands: [
    {
      ...
      takeScreenShot(screenShotName) {
        ...
        /* Take the screenshot */
        page.saveScreenshot(
          `tests/e2e/nightwatch/screenshots/CreateProject/${screenShotName}`
        );
      ...
      loginSession(
        ...
        page
          ...
          .buttonNotClickable(
            "Login",
            "UI: Login button is disabled without a valid password entered"
          )
          ...
          .waitForElementVisible(
            ...
            2000,
            "UI: Profile picture is visible after login"
          )
      ...
      uploadFileWithParameters(fileLocation, fileName) {
        ...
        page
          ...
          .uploadFile(
            fileUploadLocation,
            require("path").resolve(fileLocation + fileName)
          )
          .useCss();
      ...
      buttonNotClickable(buttonName, message) {
        ...
        const buttonLocation =
          `//*[contains(text(),'` + buttonName + `')]/parent::button`;
        page
          .useXpath()
      ...
      checkText(textName, message) {
        ...
        page.useXpath().assert.visible(elementLocation, message);
      ...
      checkUploadSuccess(message) {
        ...
        page.useXpath().assert.visible(checkMarkIcon, message).useCss();
      ...
      checkUploadFailure(message) {
        ...
        page
          ...
          .to.be.visible.assert.not.visible(checkMarkIcon, message)
          .useCss();
