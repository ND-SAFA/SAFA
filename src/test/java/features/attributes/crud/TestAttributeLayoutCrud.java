...
public class TestAttributeLayoutCrud extends AbstractCrudTest<AttributeLayoutAppEntity> {
    ...
    @Autowired
    private AttributeLayoutService attributeLayoutService;
    ...
    protected void verifyCreationMessage(EntityChangeMessage creationMessage) {
        changeMessageVerifies.verifyChangeInMessage(creationMessage, project.getProjectId(), Change.Entity.PROJECT, Change.Action.UPDATE);
    }
    ...
    protected void verifyUpdateMessage(EntityChangeMessage updateMessage) {
        changeMessageVerifies.verifyChangeInMessage(updateMessage, project.getProjectId(), Change.Entity.PROJECT, Change.Action.UPDATE);
    }
    ...
    protected void verifyDeletionMessage(EntityChangeMessage deletionMessage) {
        changeMessageVerifies.verifyChangeInMessage(deletionMessage, project.getProjectId(), Change.Entity.PROJECT, Change.Action.UPDATE);
    }
