...
from tgen.delta.delta_prompts import CHANGED_FILE_PROMPT, DIFF_SUMMARY_QUESTIONNAIRE, DIFF_SUMMARY_STARTER_PROMPT, \
    CHANGE_SUMMARY_STARTER_PROMPT, CHANGE_SUMMARY_QUESTIONNAIRE
...
class SupportedPrompts(SupportedEnum):
    ...
    # ---------- DELTA ----------------
    DELTA_CHANGED_FILE = CHANGED_FILE_PROMPT
