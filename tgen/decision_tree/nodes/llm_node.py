...
class LLMNode(AbstractNode):
    ...
    def create_prompt_builder(self, input_: Any, **kwargs) -> PromptBuilder:
        """
        ...
        """
        input_variables = self.input_variable_converter(input_, **kwargs) if self.input_variable_converter is not None else {}
        if "input" not in input_variables:
