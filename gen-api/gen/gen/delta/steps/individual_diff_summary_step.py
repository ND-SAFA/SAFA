...
from gen_common.constants.symbol_constants import DASH, EMPTY_STRING, NEW_LINE
...
from gen.delta.change_type import ChangeType
from gen.delta.delta_args import DeltaArgs
from gen.delta.delta_prompts import ADDED_PROMPT, DELETED_PROMPT, DIFF_SUMMARY_QUESTIONNAIRE, DIFF_SUMMARY_STARTER_PROMPT
from gen.delta.delta_state import DeltaState
from gen.delta.delta_util import get_prediction_output


class IndividualDiffSummaryStep(AbstractPipelineStep[DeltaArgs, DeltaState]):
    LAYER_ID = "diff"
    CHANGE_TYPE_TO_QUESTION_PROMPT = {
        ChangeType.ADDED: ADDED_PROMPT,
        ChangeType.DELETED: DELETED_PROMPT
    }
    ...
    def _run(self, args: DeltaArgs, state: DeltaState) -> None:
        ...
        for change_type in [ChangeType.MODIFIED, ChangeType.ADDED, ChangeType.DELETED]:
            ...
            questionnaire: QuestionnairePrompt = DIFF_SUMMARY_QUESTIONNAIRE
            ...
            output = get_prediction_output(args, artifact_df, state, prompts=[DIFF_SUMMARY_STARTER_PROMPT,
