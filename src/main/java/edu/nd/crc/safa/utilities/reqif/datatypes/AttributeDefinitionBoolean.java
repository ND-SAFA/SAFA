...
@XmlType(name = "ATTRIBUTE-DEFINITION-BOOLEAN", namespace = "", propOrder = {
...
public class AttributeDefinitionBoolean {
    ...
    public static class DefaultValue {
        ...
        @XmlElement(name = "ATTRIBUTE-VALUE-BOOLEAN", namespace = "")
        @Generated(value = "com.sun.tools.xjc.Driver", date = "2023-02-27T12:07:33-06:00", comments = "JAXB RI v2.3.0.1")
    ...
    public static class Type {
        ...
        @XmlElement(name = "DATATYPE-DEFINITION-BOOLEAN-REF", namespace = "")
        @XmlIDREF
