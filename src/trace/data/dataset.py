import random
from typing import List, Dict, Iterable, Sized, Optional, Set

from common.models.model_properties import ArchitectureType
from trace.config.constants import RESAMPLE_RATE_DEFAULT, VALIDATION_PERCENTAGE_DEFAULT, EVAL_DATASET_SIZE_DEFAULT, \
    LINKED_TARGETS_ONLY_DEFAULT
from trace.data.data_key import DataKey
from trace.data.trace_link import TraceLink
from trace.data.data_slice import DataSlice
