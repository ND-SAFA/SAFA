...
from gen.data.github.github_constants import COMMIT_ARTIFACT_FILE, ISSUE_ARTIFACT_FILE, PULL_ARTIFACT_FILE
from gen.data.github.gtraces.glink_finder import GLinkTarget
from gen_test.res.paths import COMMON_TEST_GITHUB_ARTIFACTS_PATH
...
class GithubTestProject:
    ...
    PROJECT_PATH = COMMON_TEST_GITHUB_ARTIFACTS_PATH
    ARTIFACT_PATHS = {
