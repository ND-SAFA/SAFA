...
class EntityReader(Generic[EntityType]):
    ...
    def __init__(self, base_path: str, definition: Dict, conversions: Dict = None):
        ...
        self.path = os.path.join(base_path, JsonUtil.get_property(definition, StructureKeys.PATH))
    ...
    def read_original_entities(self) -> pd.DataFrame:
        ...
        """
        parser_params = JsonUtil.get_property(self.definition, StructureKeys.PARAMS, {})
    ...
    def get_column_conversion(self) -> Optional[Dict]:
        ...
        if StructureKeys.COLS in self.definition:
            conversion_id = JsonUtil.get_property(self.definition, StructureKeys.COLS)
