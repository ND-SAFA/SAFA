...
class RefineArtifactContent(AbstractPipelineStep[HGenArgs, HGenState]):
    def run(self, hgen_args: HGenArgs, state: HGenState) -> None:
        ...
        :param state: The current state of the hierarchy generation at this point in time
        :return: None
        """
        ...
        refined_artifact_content = RefineArtifactContent.perform_refinement(hgen_args,
                                                                            generated_artifact_content,
                                                                            refinement_questionnaire,
                                                                            summary,
                                                                            export_path)
        state.refined_content = refined_artifact_content
