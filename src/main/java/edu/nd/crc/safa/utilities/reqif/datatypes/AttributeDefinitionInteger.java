...
@XmlType(name = "ATTRIBUTE-DEFINITION-INTEGER", namespace = "", propOrder = {
...
public class AttributeDefinitionInteger {
    ...
    public static class DefaultValue {
        ...
        @XmlElement(name = "ATTRIBUTE-VALUE-INTEGER", namespace = "")
        @Generated(value = "com.sun.tools.xjc.Driver", date = "2023-02-27T12:07:33-06:00", comments = "JAXB RI v2.3.0.1")
    ...
    public static class Type {
        ...
        @XmlElement(name = "DATATYPE-DEFINITION-INTEGER-REF", namespace = "")
        @XmlIDREF
