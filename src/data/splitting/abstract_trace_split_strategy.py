...
class AbstractTraceSplitStrategy(AbstractSplitStrategy, ABC):
    ...
    def create_split_containing_specified_link_ids(trace_dataset: TraceDataset, link_ids_for_first_split: Union[Set[str], List[str]],
        ...
        first_split_link_ids, second_split_link_ids = AbstractTraceSplitStrategy.split_data(remaining_link_ids, new_split_size, labels)
        ...
        return AbstractTraceSplitStrategy.create_dataset_slice(trace_dataset, slice_link_ids)
