...
exports.updateArtifact = exports.createArtifact = exports.deleteArtifact = exports.getDoesArtifactExist = void 0;
 ...
 */
function getDoesArtifactExist(versionId, artifactName) {
    return __awaiter(this, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, api_1.authHttpClient(api_1.fillEndpoint(api_1.Endpoint.isArtifactNameTaken, { versionId: versionId, artifactName: artifactName }), { method: "GET" })];
                case 1:
                    res = _a.sent();
                    return [2 /*return*/, res.artifactExists];
            }
        });
    });
}
exports.getDoesArtifactExist = getDoesArtifactExist;
/**
 ...
 */
function createArtifact(versionId, artifact) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, api_1.CommitBuilder.withCurrentVersion()
 ...
 */
function updateArtifact(versionId, artifact) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, api_1.CommitBuilder.withCurrentVersion()
