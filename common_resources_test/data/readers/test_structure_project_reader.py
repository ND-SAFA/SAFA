...
from common_resources_test.base_tests.abstract_project_reader_test import AbstractProjectReaderTest
...
from common_resources_test.paths.project_paths import STRUCTURE_PROJECT_PATH
