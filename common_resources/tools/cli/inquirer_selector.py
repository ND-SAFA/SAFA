...
from common_resources.tools.constants.cli_constants import EXIT_COMMAND, BACK_COMMAND, EXIT_MESSAGE, REQUIRED_FIELD_ERROR
from common_resources.tools.t_logging.logger_manager import logger

from common_resources.tools.constants.symbol_constants import F_SLASH, EMPTY_STRING, NEW_LINE
