...
class CombinationSplitStrategy(AbstractTraceSplitStrategy):
    """
    ...
    def create_split(dataset: TraceDataset, percent_split: float, slice_num: int, n_sources: int = 2) -> TraceDataset:
        """
        ...
        source_link_ids_first_split = {link.id for link
                                       in SourceSplitStrategy.create_trace_link_array_by_source(dataset, n_sources=n_sources)}
