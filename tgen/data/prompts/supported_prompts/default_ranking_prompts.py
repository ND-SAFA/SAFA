...
QUESTION2 = (
    ...
    "\n    - For `EXPLANATION` provide three detailed sentences answering the questions in the order below:"
    "\n        1. What is this functionality of the child artifact?"
    "\n        2. What is the goal of the child artifact?"
    "\n        2. How does the child artifact affect the primary goal of the parent artifact?"
    ...
    "Use the following guidelines to create the score:"
    ...
    "\n        * 6 = Child artifact performs a related but distant function of the parent artifact"
