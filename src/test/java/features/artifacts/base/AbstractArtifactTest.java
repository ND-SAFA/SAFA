...
import edu.nd.crc.safa.features.artifacts.entities.db.IArtifact;
...
public abstract class AbstractArtifactTest<T extends IArtifact> extends ApplicationBaseTest {
    ...
    protected String newArtifactBody = "this is a new body";
    protected String documentName = "document-name";
    protected String documentDescription = "document-description";
