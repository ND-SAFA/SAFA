...
@Entity
@Table(name = "float_field_value")
@Getter
@Setter
@ToString
@RequiredArgsConstructor
public class FloatFieldValue implements IFieldValue {
    @Id
    @GeneratedValue
    @Type(type = "uuid-char")
    @Column
    ...
    public void save(ArtifactSystemServiceProvider serviceProvider) {
        FloatFieldValueRepository repo = serviceProvider.getFloatFieldValueRepository();
        Optional<FloatFieldValue> existing = repo.getByFieldVersion(this.fieldVersion);
