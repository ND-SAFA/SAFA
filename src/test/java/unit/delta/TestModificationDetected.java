...
public class TestModificationDetected extends ApplicationBaseTest {
    ...
    public void testModificationDetected() throws Exception {
        ...
        ProjectAppEntity beforeAppEntity = this.projectRetrievalService.retrieveProjectAppEntityAtProjectVersion(beforeVersion);
        ...
        ProjectAppEntity afterAppEntity = this.projectRetrievalService.retrieveProjectAppEntityAtProjectVersion(afterVersion);
