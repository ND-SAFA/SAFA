...
public class ParseDataFileController extends BaseController {
    ...
    public SafaResponse parseArtifactFile(@PathVariable String artifactType,
    ...
    public SafaResponse checkIfNameExists(@PathVariable UUID versionId,
    ...
    @ResponseStatus(HttpStatus.OK)
    public SafaResponse parseTraceFile(@RequestParam MultipartFile file) {
