...
def generate_artifact_content(hgen_args: HGenArgs) -> None:
    ...
    summary_questionnaire, format_of_artifacts = construct_questionnaire(hgen_args)

    source_layer_only_dataset = hgen_args.state.source_dataset
    export_path = hgen_args.state.export_path

    hgen_args.format_of_artifacts = format_of_artifacts
    hgen_args.state.generation_questionnaire = summary_questionnaire
