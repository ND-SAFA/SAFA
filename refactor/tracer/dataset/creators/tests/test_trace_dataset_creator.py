...
from tracer.dataset import Artifact, TraceDatasetCreator, TraceLink
from tracer.models import ModelGenerator, SupportedBaseModel
...
class TestTraceDatasetCreator(BaseTest):
    ...
    def test_get_data_split(self):
        ...
        val_split = test_trace_dataset_creator._get_data_split(self.ALL_LINKS, for_second_split=True)
    ...
    def test_get_train_split_size(self):
        test_trace_dataset_creator = self.get_test_trace_dataset_creator()
        split_size = test_trace_dataset_creator._get_first_split_size(self.ALL_LINKS)
