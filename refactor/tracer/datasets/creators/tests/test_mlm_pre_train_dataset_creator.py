...
class TestMLMPreTrainDatasetCreator(BaseTest):
    ...
    def test_pre_train_file_aggregation(self):
        """
        Tests that creating a pre-training datasets results in the aggregation of files in pre-training directory.
        """
    ...
    def test_get_file_list(self):
        """
        Tests that pre-training datasets creator is able to retrieve relevant files in pre-training directory.
        """
    ...
    def get_mlm_pre_train_dataset_creator(self):
        return MLMPreTrainDatasetCreator(self.PRETRAIN_DIR,
                                         TEST_OUTPUT_DIR,
                                         pre_processing_steps=self.PRE_PROCESSING_PARAMS)
