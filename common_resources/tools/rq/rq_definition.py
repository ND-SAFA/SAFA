...
from common_resources.tools.constants.rq_constants import MISSING_DEFINITION_ERROR, RQ_INQUIRER_CONFIRM_MESSAGE, RQ_VARIABLE_START, \
    RQ_VARIABLE_REGEX
from common_resources.tools.constants.symbol_constants import EMPTY_STRING, NEW_LINE, NONE
from common_resources.tools.rq.rq_variable import RQVariable
