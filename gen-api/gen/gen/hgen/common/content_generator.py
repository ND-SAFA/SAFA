...
from gen.constants.hgen_constants import DEFAULT_REDUCTION_PERCENTAGE_GENERATIONS
from gen.hgen.common.hgen_util import HGenUtil
from gen.hgen.common.special_doc_types import DocTypeConstraints
from gen.hgen.hgen_args import HGenArgs, PredictionStep
...
class ContentGenerator:
    ...
    def create_prompt_builder(self, base_intro_prompt: Prompt, base_task_prompt: Prompt,
                              source_type: str,
        ...
        """
        task_prompt = self._create_generations_task_prompt(base_task_prompt, cluster2artifacts,
        ...
        prompts = [base_intro_prompt, artifact_prompt]
        if context_mapping:
